...
const Edit = () => {
    const { AnuncioId } = useParams(); // Obtén el ID del anuncio desde la URL
    ...
    const handleSubmit = async (e) => {
        ...
        const updatedAnuncio = {
            ...formData,
            tiempo: Date.now(), // O usa el tiempo original si prefieres no actualizar
        };

        try {
            // Actualiza el anuncio en Firebase
